...
3. Mengenalkan tools pengembangan web yang umum digunakan
...
Digunakan untuk mengatur tampilan visual, seperti warna, layout, ukuran, dan font.

3. JavaScript (Dasar)
Digunakan untuk menambahkan interaktivitas, seperti tombol yang bisa diklik atau animasi ringan.

4. Struktur File Proyek Web
Mengajarkan bagaimana menyusun file dan folder dengan rapi.
...
![HTML Link dan Lists](/assets/images/gambar2.jpg)